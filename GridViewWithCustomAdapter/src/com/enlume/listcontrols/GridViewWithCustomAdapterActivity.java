...
public class GridViewWithCustomAdapterActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new GridviewAdapter(this,listCountry, listFlag);
        ...
        gridView.setOnItemClickListener(new OnItemClickListener() 
        {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int position,
					long arg3) {
				Toast.makeText(GridViewWithCustomAdapterActivity.this, adapter.getItem(position), Toast.LENGTH_SHORT).show();
			}
		});
