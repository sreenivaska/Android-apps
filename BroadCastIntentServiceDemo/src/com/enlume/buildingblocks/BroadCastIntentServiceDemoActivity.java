package com.enlume.buildingblocks;
...
public class BroadCastIntentServiceDemoActivity extends Activity {
	   private ResponseReceiver receiver;
	    ...
	    public void myBadButtonClickHandler(View target) {
	        ...
	        SystemClock.sleep(30000); // 30 seconds, makes app unresponsive, does not queue up, bad developer, no donut
	    ...
	    public class ResponseReceiver extends BroadcastReceiver {
	        public static final String ACTION_RESP = "com.enlume.intent.MESSAGE_PROCESSED";
	        @Override
